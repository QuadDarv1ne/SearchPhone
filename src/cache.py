...
from src.config import CACHE_DIR, CACHE_ENABLED, CACHE_MAX_AGE_DAYS
...
class CacheManager:
    ...
    def get_stats(self):
        ...
        return {"total_files": total_files, "total_size_bytes": total_size, "expired_count": expired_count}
